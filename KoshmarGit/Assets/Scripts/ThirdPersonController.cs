...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void CameraRotation()
        {
            ...
            float leanAmount = Mathf.InverseLerp(BottomClamp, TopClamp, _cinemachineTargetPitch);
            leanAmount = Mathf.Clamp(leanAmount * 2f - 1f, -1f, 1f);
            //Debug.Log(leanAmount);

            if (_hasAnimator)
            {
                    _animator.SetFloat(_animIDLeanAmount, leanAmount);
            }
